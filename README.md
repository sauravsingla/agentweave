...
| **External public benchmark data** | ✅ | 490 pinned AgentBench task records |
| **Synthetic benchmark data** | ✅ | generated populations, capabilities, trust, latency/cost, adversarial fixtures, and AgentBench candidate-agent catalog |
...
The 10K/100K/1M execution is real computation over synthetic records. AgentBench provides external published task text, but the candidate-agent catalog is synthetic. Those evidence types are intentionally reported separately.
